...
export const metadata: Metadata = {
  ...
  title: {
    ...
    default: 'Super Palpite — Bolões de Placar Exato',
  },
  description: 'Acerte o placar exato de jogos de futebol, pague via Pix e concorra ao prêmio. Bolões com apuração automática, prêmio garantido e resultado em tempo real.',
  keywords: ['bolão', 'placar exato', 'palpite futebol', 'bolão pix', 'prêmio futebol'],
  ...
  openGraph: {
    ...
    description: 'Acerte o placar exato, pague via Pix e concorra ao prêmio. Bolões de futebol com apuração automática.',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Super Palpite — Bolões de Placar Exato' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Super Palpite — Bolões de Placar Exato',
    description: 'Acerte o placar exato, pague via Pix e concorra ao prêmio.',
    images: ['/og-image.png'],
  },
